...
import { AddMethodData, UpdateMethodData } from "src/DAL/Methods/Method";
...
export const EditMethod = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("charge", inputs?.charge);
    formData.append("currency_name", inputs?.currency_name);
    formData.append("_method", "put");

    const resp = await UpdateMethodData(id, formData);
    if (resp?.status == true) {
  ...
  useEffect(() => {
    ...
    setQRcodePreview(state?.qr_code);
  }, []);
